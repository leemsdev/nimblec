...
inline static std::string type_to_str(token_type t) {
	switch (t) {
		case token_type::keyword_print: return "print";
		case token_type::string: return "string";
		case token_type::ident: return "identifier";
...
inline static std::optional<tokens::token_type> try_match_keyword(std::string * src, token t) {
